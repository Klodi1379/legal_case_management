"""
Django settings for legal_case_management project - Safe version.
"""
import os
import sys
...
SECRET_KEY = 'django-insecure-safe-key-for-development'

# ALWAYS SET DEBUG TO TRUE FOR NOW
DEBUG = True

# ALWAYS SET ALLOWED_HOSTS EXPLICITLY
ALLOWED_HOSTS = ['*', 'localhost', '127.0.0.1']  # Allow all hosts for development

# Print debug information
print(f"Settings module being loaded: {__file__}")
